    ...
    public class BucketSystem : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            in Position2D position) =>
            {
                                    ...
                                    offset.x++)
                                {
                                    if (grid.Physical.ContainsKey(gridPos + offset))
                                    {
                                        ...
                                        if (cell.Flags == Grid.Cell.ContentFlags.Fire)
                                        {
                                            ...
                                            fireGradient.Value -= gradientState.Value *
                ...
                scale.Value = new float3(math.lerp(bucketSingleton.Size_Empty, bucketSingleton.Size_Full, math.min(1, gradientState.Value)));
